...
namespace ActionQueue
{
    public class NodeEditor : EditorWindow
    {
        ...
        private void DrawGrid()
        {
            GL.PushMatrix();
            GL.Begin(1);
            this.DrawGridLines(scaledCanvasSize, NodeEditor.GridMinorSize, offset, ActionQueueEditorStyles.gridMinorColor);
            this.DrawGridLines(scaledCanvasSize, NodeEditor.GridMajorSize, offset, ActionQueueEditorStyles.gridMajorColor);
            GL.End();
            GL.PopMatrix();
        }
